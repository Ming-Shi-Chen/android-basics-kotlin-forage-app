...
import com.example.forage.data.CountDownDatabase

/**
 * An application class that inherits from [Application], allows for the creation of a singleton
 * instance of the [CountDownDatabase]
 */
class BaseApplication : Application() {

    // TODO: provide a ForageDatabase value by lazy here
    val database: CountDownDatabase by lazy { CountDownDatabase.getDatabase(this)}
}